...
// Creat the grid in which the snake is
...
const getCellClassName = (
  ...
  const handleKeydown = e => {
    ...
    if (getOppositeDirection(newDirection) === direction) {
      return; // Do nothing if the new direction is opposite
    }
  
    if (!isValidDirection) return;
  
    setDirection(newDirection); // Update direction if valid and not opposite
  };
  ...
  const handleNewGame = () => {
    ...
    //i wantta modal to get riggered here and thath n=modal will have play button which will continuate the trext of code 
